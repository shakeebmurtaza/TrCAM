...
from dlib.slotattentionmodel_vitbackbone.slot_attention_utils import Tensor
from dlib.slotattentionmodel_vitbackbone.slot_attention_utils import assert_shape
from dlib.slotattentionmodel_vitbackbone.slot_attention_utils import build_grid
from dlib.slotattentionmodel_vitbackbone.slot_attention_utils import conv_transpose_out_shape
...
class SlotAttentionModel(nn.Module):
    ...
    def forward(self, x, encoder_out):
        ...
        slots_intermediate = self.slot_attention(encoder_out)
        assert_shape(slots_intermediate.size(), (batch_size, self.num_slots, self.slot_size))
        # `slots_intermediate` has shape: [batch_size, num_slots, slot_size].
        batch_size, num_slots, slot_size = slots_intermediate.shape

        slots = slots_intermediate.view(batch_size * num_slots, slot_size, 1, 1)
        ...
        return recon_combined, recons, masks, slots, slots_intermediate
