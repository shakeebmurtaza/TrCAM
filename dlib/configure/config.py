...
def get_config(ds):
    ...
    args = {
        ...
        'calculate_metric_per_class': False,  # if true, we calculate the
        # metric per class. otherwise, we only calculate the metric over all classes.
        ...
        'save_cams_before_training': False,  # save cams fro sampling before training
        'search_hps': False,  # search hyper-parameters,
        'hps_search_optimizer': constants.OPTIMIZER_OPTUNA,  # optimizer name for searching hps
        'only_create_optimizer_for_searching_hps': False,
        'use_on_the_fly_cams_after_half_epochs': False,  # Whether or not use on the fly after half epochs pseduo labels for training
    }
